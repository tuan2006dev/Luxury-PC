...
public interface NewsRepository extends JpaRepository<News, Integer> {
    ...
    Page<poly.edu.dto.NewsSummaryDto> findByStatusOrderByCreatedAtDesc(@Param("status") NewsStatus status, Pageable pageable);
    ...
    Page<poly.edu.dto.NewsSummaryDto> findByCategoryIdAndStatusOrderByCreatedAtDesc(@Param("categoryId") Integer categoryId, @Param("status") NewsStatus status, Pageable pageable);
    ...
    List<poly.edu.dto.NewsSummaryDto> findRelatedNews(@Param("categoryId") Integer categoryId, @Param("excludeId") Integer excludeId, Pageable pageable);
    ...
    Page<poly.edu.dto.NewsSummaryDto> findAllSummary(Pageable pageable);
    ...
    Page<poly.edu.dto.NewsSummaryDto> searchAllNewsSummary(@Param("keyword") String keyword, Pageable pageable);
}
